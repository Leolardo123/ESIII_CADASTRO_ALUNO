            ...
            <form class="row justify-content-center align-items-center" action="EditarAluno" method="post">
                ...
                <div class="row my-3">
                    ...
                    <div class="col-sm-7 my-2">
                        <select class="form-select" name="curso" id="select-curso" required>
                ...
                <div class="text-center">
                    ...
                    <a class="col-sm-2 btn btn-s" href="./aluno.jsp">Voltar</a>
                </div>
                <!-- BotÃ£o de Envio -->
                <div class="col-sm-5 my-2"><input type="hidden" pattern="[0-9]+" maxlength="10" class="form-control" name="rg" placeholder="RG" value="<%=aluno.getRg()%>" required></div>
                <div class="col-sm-7 my-2"><input type="hidden" pattern="[0-9]+" maxlength="11" class="form-control" name="cpf" placeholder="CPF" value="<%=aluno.getCpf()%>" required></div>
            </form>
            <!-- FormulÃ¡rio -->
        ...
        <script>
            window.addEventListener('load', function () {
                var cbfun = function (cursos) {
                    ...
                    var select_itens = '<option class="opcao-cadastrada" value="<%=curso.getId()%>"><%=curso.getNome()%></option>'
                    for (const [chave, curso] of Object.entries(cursos)) {
                        if (curso["id"] != '<%=curso.getId()%>') {

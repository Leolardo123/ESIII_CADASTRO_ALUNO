    ...
    <div class="container my-5">
        ...
        <form class="row justify-content-center align-items-center" action="">
            ...
            <div class="row my-3">
                ...
                <div class="col-sm-7 my-2"><input type="number" pattern="[0-9]+([\.,][0-9]+)?" step="0.01" min="0.00" class="form-control" name="salario" placeholder="Sal�rio" required></div>
            </div>
            <!-- Dados Cadastrais Pessoa -->
            ...
            <div class="text-center">
                ...
                <a class="col-sm-2 btn btn-secondary" href="./professor.jsp">Voltar</a>
            </div>
             <!-- Botão de Envio -->
